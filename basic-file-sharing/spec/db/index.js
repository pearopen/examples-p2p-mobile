...
// '@basic-file-sharing/invites' collection key
...
// '@basic-file-sharing/invites' key reconstruction function
...
const collection0 = {
  name: '@basic-file-sharing/invites',
  id: 0,
  version: 1,
  encodeKey (record) {
    const key = [record.id]
...
// '@basic-file-sharing/drives' collection key
...
// '@basic-file-sharing/drives' key reconstruction function
...
const collection1 = {
  name: '@basic-file-sharing/drives',
  id: 1,
  version: 1,
  encodeKey (record) {
...
function resolveCollection (name) {
  switch (name) {
    case '@basic-file-sharing/invites': return collection0
    case '@basic-file-sharing/drives': return collection1
    default: return null
  }
}

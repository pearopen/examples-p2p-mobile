...
class Router {
  ...
  add (name, handler) {
    switch (name) {
      case '@basic-file-sharing/add-writer':
        this._handler0 = handler
        break
      case '@basic-file-sharing/add-invite':
        this._handler1 = handler
        break
      case '@basic-file-sharing/add-drive':
  ...
  _checkAll () {
    assert(this._handler0 !== null, 'Missing handler for "@basic-file-sharing/add-writer"')
    assert(this._handler1 !== null, 'Missing handler for "@basic-file-sharing/add-invite"')
    assert(this._handler2 !== null, 'Missing handler for "@basic-file-sharing/add-drive"')
  }

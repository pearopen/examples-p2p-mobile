...
// @basic-chat-blind-peering/writer
const encoding1 = {
  preencode(state, m) {
...
// @basic-chat-blind-peering/invite
const encoding2 = {
  preencode(state, m) {
...
// @basic-chat-blind-peering/message
const encoding3 = {
  preencode(state, m) {
...
// @basic-chat-blind-peering/invite/hyperdb#0
const encoding5 = {
  preencode(state, m) {
    c.buffer.preencode(state, m.invite)
    c.buffer.preencode(state, m.publicKey)
...
// @basic-chat-blind-peering/message/hyperdb#1
const encoding6 = {
  preencode(state, m) {
    c.string.preencode(state, m.text)
    state.end++ // max flag is 1 so always one byte
...
function getEncoding(name) {
  switch (name) {
    case '@basic-chat-blind-peering/log':
      return encoding0
    case '@basic-chat-blind-peering/writer':
      return encoding1
    case '@basic-chat-blind-peering/invite':
      return encoding2
    case '@basic-chat-blind-peering/message':
      return encoding3
    case '@basic-chat-blind-peering/messages':
      return encoding4
    case '@basic-chat-blind-peering/invite/hyperdb#0':
      return encoding5
    case '@basic-chat-blind-peering/message/hyperdb#1':
      return encoding6
    default:

...
class Router {
  ...
  add (name, handler) {
    switch (name) {
      case '@basic-chat/add-writer':
        this._handler0 = handler
        break
      case '@basic-chat/add-invite':
        this._handler1 = handler
        break
      case '@basic-chat/add-message':
  ...
  _checkAll () {
    assert(this._handler0 !== null, 'Missing handler for "@basic-chat/add-writer"')
    assert(this._handler1 !== null, 'Missing handler for "@basic-chat/add-invite"')
    assert(this._handler2 !== null, 'Missing handler for "@basic-chat/add-message"')
  }
